...
const Home = ({ xRotation, yRotation, scale, isMobile }) => {


    return (
        <>
            <Background3D isMobile={isMobile} yRotation={yRotation} xRotation={xRotation} scale={scale} />
            <div className="h-screen w-full flex justify-center" style={{ backgroundColor: 'black' }}>
                <div className="flex items-center px-7 h-full absolute md:w-1/2 w-5/6">
                    <div className="">
